const menuItems = [
  {
    ...
    imgOrder: "order-1 md:order-2",
    cols: "md:col-span-5",
    imgCols: "md:col-span-7",
  },
  {
    ...
    order: "md:col-span-5 md:col-start-8",
    imgOrder: "",
    cols: "",
    imgCols: "md:col-span-6",
  },
  {
    ...
    <section id="menu" className="py-32 bg-white selection:bg-[#1a1a1a] selection:text-white">
      <div className="max-w-[90rem] mx-auto px-8 md:px-24">
        ...
        {menuItems.map((item, idx) => (
          <div key={idx} className={`grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24 items-center ${idx !== menuItems.length - 1 ? 'mb-40' : ''} group cursor-pointer`}>
            
            <div className={`${item.cols} ${item.order} space-y-8`}>
              <h3 className="font-serif text-4xl md:text-5xl font-light tracking-tight group-hover:text-[#1a1a1a]/70 transition-colors duration-500">{item.title}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24 items-center mt-40 group cursor-pointer">
